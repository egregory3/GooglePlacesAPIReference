package com.ericgregory.myapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btn_find_current_place, btn_get_photo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //init View
        btn_find_current_place = (Button)findViewById(R.id.btn_get_current_place);
        edt_address = (EditText) findViewById(R.id.edt_address);
        edt_place_likelihoods= (EditText) findViewById(R.id.edt_likelihood);
        ...
        btn_get_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(placeId)){
                    Toast.makeText(MainActivity.this, "Places Id must not be null", Toast.LENGTH_SHORT).show();
                    return;
                }
                else
                {
    ...
    private void getPhotoAndDetail(final String placeId) {
                ...
                .addOnSuccessListener(new OnSuccessListener<FetchPlaceResponse>() {
                    ...
                    public void onSuccess(FetchPlaceResponse fetchPlaceResponse) {
                        ...
                        FetchPlaceRequest request = FetchPlaceRequest
                                .builder(placeId, Arrays.asList(Place.Field.LAT_LNG)).build();
                        placesClient.fetchPlace(request)
                                .addOnCompleteListener(new OnCompleteListener<FetchPlaceResponse>() {
                                    ...
                                    public void onComplete(@NonNull Task<FetchPlaceResponse> task) {
                                        if(task.isSuccessful())
                                        {
                                            ...
                                            textView.setText(new StringBuilder(String.valueOf(place.getLatLng().latitude))
        ...
        Dexter.withActivity(this)
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionRationaleShouldBeShown(List<PermissionRequest> permissions, PermissionToken token) {
                        Toast.makeText(MainActivity.this, "You must enable this permissions", Toast.LENGTH_SHORT).show();
                    }
                }).check();
    }
        ...
        placeResponseTask.addOnCompleteListener(new OnCompleteListener<FindCurrentPlaceResponse>() {
            ...
            public void onComplete(@NonNull Task<FindCurrentPlaceResponse> task) {
                if(task.isSuccessful()){
                    ...
                    edt_address.setText(new StringBuffer(response.getPlaceLikelihoods()
                            .get(0)
                            .getPlace()
                            .getAddress()));
                    //Loop and set all likelihoods
    ...
    private void initPlaces() {
        Places.initialize(this, this.getString(R.string.places_api_key));
